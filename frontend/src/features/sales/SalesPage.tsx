...
export function SalesPage() {
  ...
  return (
    <div className="grid gap-4 xl:gap-5">
      ...
      <div className="grid items-start gap-4 xl:grid-cols-[380px_minmax(0,1fr)] 2xl:grid-cols-[420px_minmax(0,1fr)]">
            ...
            {latestError ? (
              ...
              <div className="mt-6 rounded-3xl border border-slate-800 bg-slate-950/50 p-5">
                ...
                <div className="mt-5 flex gap-3">
                  <Button variant="secondary" onClick={() => setSelectedReceipt(latestSale)}>
                    Ver detalle
                  </Button>
                </div>
              </div>
                ...
                <div className="mt-6 overflow-hidden rounded-3xl border border-slate-800">
                  ...
                  <ScrollPanel maxHeightClassName="max-h-[30rem]">
                    {historyItems.map((sale) => (
                      <div
                        key={`${sale.sale_id}-${sale.created_at}`}
                        className="grid grid-cols-[92px_150px_120px_110px_140px_140px_minmax(0,1fr)_110px] gap-3 border-t border-slate-800 bg-slate-950/50 px-4 py-4 text-sm text-slate-200"
                      >
