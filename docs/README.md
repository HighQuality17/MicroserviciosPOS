...
- [`navigation-and-layout-updates.md`](navigation-and-layout-updates.md): nota técnica breve de la mejora reciente de navegación responsive y colapso del sidebar.
